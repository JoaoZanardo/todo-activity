...
export class AccessControlService {
  ...
  // private async processAccessPointEquipments (accessPoint: AccessPointModel, tenantId: Types.ObjectId) {
  //   const { equipmentsIds } = accessPoint.object
